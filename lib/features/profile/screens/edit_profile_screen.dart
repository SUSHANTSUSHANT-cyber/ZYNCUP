...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _pickProfileImage() async {
    ...
    try {
      ...
      setState(() {
        _isPickingImage = false;
        _errorMessage = 'Unable to select the image: $error';
      });
    }
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      debugPrint('========== PROFILE SAVE DEBUG ==========');
      debugPrint('Auth user ID: ${currentUser?.id}');
      debugPrint('Profile ID: ${widget.profile.id}');
      debugPrint(
        'IDs match: ${currentUser?.id == widget.profile.id}',
      );
      debugPrint('========================================');
                  ...
                  children: [
                    Center(
                      child: GestureDetector(
                        onTap: (_isSaving || _isPickingImage)
                            ? null
                            : _pickProfileImage,
                        child: Stack(
